...
-assumenosideeffects class ru.nikitenkogleb.mpegencoder.MpegEncoder {
    private static void logv(java.lang.String);
    private static void logw(java.lang.String);
    private static void logw(java.lang.Throwable);
}

-assumenosideeffects class ru.nikitenkogleb.mpegencoder.InputSurface {
    private static void logv(java.lang.String);
    private static void logw(java.lang.String);
    private static void logw(java.lang.Throwable);
}

-assumenosideeffects class ru.nikitenkogleb.mpegencoder.GLTools {
